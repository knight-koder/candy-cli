...
exports.ExamplesModule = void 0;
const common_1 = require("@nestjs/common");
const database_module_1 = require("../database/postgres/database.module");
const postgres_example_controller_1 = require("./rest/postgres-example.controller");
let ExamplesModule = class ExamplesModule {
};
exports.ExamplesModule = ExamplesModule;
exports.ExamplesModule = ExamplesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            database_module_1.PostgresDatabaseModule,
        ],
        controllers: [
            postgres_example_controller_1.ExampleController,
        ],
    })
], ExamplesModule);
