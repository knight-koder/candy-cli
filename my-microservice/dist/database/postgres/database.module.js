        ...
        imports: [
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    ...
                    database: configService.get('POSTGRES_DB') || 'my-microservice',
            ...
            typeorm_1.TypeOrmModule.forFeature([example_entity_1.ExampleEntity]),
        ],
        providers: [database_service_1.PostgresDatabaseService],
        exports: [database_service_1.PostgresDatabaseService, typeorm_1.TypeOrmModule],
    })
