...
import { ExampleController } from './postgres-example.controller';
import { ExampleEntity } from '../../database/postgres/example.entity';
import { NotFoundException } from '@nestjs/common';

describe('ExampleController (Postgres)', () => {
